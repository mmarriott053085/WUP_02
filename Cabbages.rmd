...
```
The comparison between the two data analysis from boxplot c39 and c52, gives the precise median for both and gives additional data such as height,which is represented in Q1 and Q3 respectively.
