...
```
The data point collected is 0.00000003405 showing it is quite small  the difference reflects that between the two groups where the data is collected c39 and c52 there is a 95% difference when comparing the two groups, as they are both statistically different.
